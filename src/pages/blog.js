                ...
                <article className="clearfix blogpost">
                  ...
                  <div className="blogpost-body">
                    ...
                    <div className="blogpost-content">
                      ...
                      <p>
                        Để đáp ứng nhu cầu phát triển, HT Active cần tuyển nhiều
                        vị trí lập trình viên Junior - Senior.
                      </p>
                    </div>
                  </div>
                  <footer className="clearfix hidden">
                    <ul className="links pull-left hidden">
                      ...
                      <li>
                        <i className="fa fa-tags pr-5" /> <a href="#">tag 1</a>
                      </li>
                    </ul>
                    <a
                ...
                <article className="clearfix blogpost">
                  ...
                  <div className="blogpost-body">
                    ...
                    <div className="blogpost-content">
                      ...
                      <p>
                        Để đáp ứng nhu cầu phát triển, HT Active cần tuyển 2 PHP
                        Developer.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="blogpost-body">
                    ...
                    <div className="blogpost-content">
                      ...
                      <p>
                        ...
                        biết sử dụng máy tính hoặc điện thoại di động, hoặc máy
                        tính bảng hoặc lọt vào những trường hợp còn lại. Sở dĩ
                        tôi biết được...
                      </p>
                    </div>
                  </div>
