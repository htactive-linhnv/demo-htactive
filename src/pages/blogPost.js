                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="main col-md-8">
                            {/* page-title start */}
                            {/* ================ */}
                            <h1 className="page-title">Những Material component tuyệt vời trong React Native.</h1>
                            {/* page-title end */}
                            {/* blogpost start */}
                            <article className="clearfix blogpost full">
                                <div className="blogpost-body">
                                    <div className="side">
                                        ...
                                        <div id="affix" className="affix-top"><span className="share">Share this</span><div id="share" className="sharrre"><ul className="social-links clearfix"><li className="facebook"><a><i className="fa fa-facebook" /></a></li><li className="twitter"><a><i className="fa fa-twitter" /></a></li><li className="googleplus"><a><i className="fa fa-google-plus" /></a></li></ul></div></div>
                                    </div>
                                ...
                                <div className="block clearfix">
                                    ...
                                    <div className="image-box">
                                        <div className="overlay-container">
                                            <img src="https://www.techworm.net/wp-content/uploads/2018/03/wc-swift.jpg" alt="" />
                                        ...
                                        <div className="image-box-body">
                                            <h3 className="title"><a href="news-detail/1/hello-world-voi-swift">Hello World với Swift</a></h3>
                                            ...
                                            <a href="news-detail/1/hello-world-voi-swift" className="link"><span>Read more</span></a>
                                        </div>
                                    </div>
                                    <div className="image-box">
                                        <div className="overlay-container">
                                            <img src="https://scontent.fdad3-2.fna.fbcdn.net/v/t31.0-0/p180x540/14054324_10154624375358984_2240899986652458346_o.jpg?oh=53816cd88c9c9eb2305b12fd8bcbd1de&oe=5A46DDF2" alt="" />
                                            <div className="overlay">
                                                <div className="overlay-links">
                                        ...
                                        <div className="image-box-body">
                                            <h3 className="title"><a href="news-detail/2/huong-dan-assembly-64-bit">Hướng dẫn Assembly 64bit.</a></h3>
                                            ...
                                            <a href="news-detail/2/huong-dan-assembly-64-bit" className="link"><span>Read more</span></a>
                                        </div>
                                    </div>
                                    <div className="image-box">
                                        <div className="overlay-container">
                                        ...
                                        <div className="image-box-body">
                                            <h3 className="title"><a href="news-detail/3/huong-dan-assembly-64-bit-bai-2">Hướng dẫn Assembly 64bit - Bài 2.</a></h3>
                                            ...
                                            <a href="news-detail/3/huong-dan-assembly-64-bit-bai-2" className="link"><span>Read more</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
